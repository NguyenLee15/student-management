    ...
    >
      {!success ? (
        <form onSubmit={handleSubmit} className="space-y-4 text-sm" noValidate>
          {error && (
            <div className="flex items-center gap-2.5 p-3 rounded-xl bg-rose-500/10 border border-rose-500/30 text-rose-200 text-sm" role="alert">
          ...
          <div>
            <label htmlFor="forgot-email" className="block text-sm font-semibold text-slate-200 mb-1.5">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 bg-slate-950 border border-slate-700 rounded-xl text-sm text-slate-100 placeholder:text-slate-500 focus:outline-none focus:border-indigo-400 focus:ring-2 focus:ring-indigo-400/30 transition"
              />
            </div>
            <p id="forgot-email-helper" className="text-xs text-slate-400 mt-2 leading-relaxed">
          ...
          <div className="pt-3 flex justify-between items-center border-t border-slate-800/80">
            <button
              ...
              className="min-h-[40px] text-indigo-300 hover:text-indigo-200 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400 rounded-lg px-1"
            >
              ← Quay lại Đăng nhập
            </button>
            ...
            <div className="flex gap-2.5">
              <button
                type="button"
                onClick={handleClose}
                className="min-h-[40px] px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-700 text-slate-300 hover:text-slate-100 text-sm font-medium transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-400"
              >
                Đóng
              </button>
              <button
                ...
                className="flex min-h-[40px] items-center gap-2 px-5 py-2 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold shadow-lg shadow-indigo-600/30 transition active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 disabled:cursor-not-allowed disabled:opacity-50"
              >
                {loading ? (
                  <>
        ...
        <div className="space-y-5 text-center py-3">
          ...
          <div className="pt-3 border-t border-slate-800/80">
            <button
              type="button"
              onClick={onBackToLogin}
              className="w-full min-h-[40px] flex items-center justify-center gap-2 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold shadow-lg shadow-indigo-600/30 transition active:scale-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-300 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
            >
